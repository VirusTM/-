...
%1.1
prlongest:- see('C:/Users/VirusTM/Documents/Prolog/lab8/completion.txt'), read_list_str(_, LengthList),
...
%1.2
prno_spaces:- see('C:/Users/VirusTM/Documents/Prolog/lab8/completion.txt'), read_list_str_space(_, C),
...
%1.3
prmore_than_A:- see('C:/Users/VirusTM/Documents/Prolog/lab8/completion.txt'), count_A(_,N,C), M is C/N,
	 seen, see('C:/Users/VirusTM/Documents/Prolog/lab8/completion.txt'), read_list_str_A(_,M), seen.
...
%1.4
prfrequent:- see('C:/Users/VirusTM/Documents/Prolog/lab8/completion.txt'), read_list_str1(List), seen,
...
%1.5
prnot_repeat:- see('C:/Users/VirusTM/Documents/Prolog/lab8/completion.txt'), read_list_str1(List), seen,
	unique_words(List,List,[],R), see('C:/Users/VirusTM/Documents/Prolog/lab8/completion.txt'),
	read_list_str2(_,R,ResList), seen, tell('C:/Users/VirusTM/Documents/Prolog/lab8/completion.txt'),
...
% 3
prdate:-read_str(Str,_,_),pr3(Str,Res),write_list_str(Res).
...
% 5
prarrange1:- see('C:/Users/VirusTM/Documents/Prolog/lab8/completion.txt'), read_list_str(List,LengthList), seen,
...
% 6
prarrange2:- see('C:/Users/VirusTM/Documents/Prolog/lab8/completion.txt'), read_str_count_words(List,CountWordsList),
...
% 7
prarrange3:- see('C:/Users/VirusTM/Documents/Prolog/lab8/completion.txt'), read_str_after(List,CountWordsList),
	seen, sort_list(List,CountWordsList,[],SList), write1(SList).
